...
func main() {
    ...
    fmt.Printf("int_list1: %v\n", int_list1)                            // [ 1 -> 2 -> 3 -> 4 -> 3 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list1.Head, int_list1.Tail) // 1 - 3
    fmt.Printf("int_list2: %v\n", int_list2)                            // [ 5 -> 4 -> 3 -> 2 -> 1 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list2.Head, int_list2.Tail) // 5 - 1
    fmt.Printf("str_list2: %v\n", str_list2)                            // [ a -> b -> c -> d -> e -> f ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list2.Head, str_list2.Tail) // a - f
    fmt.Printf("str_list3: %v\n", str_list3)                            // [ x -> y -> z -> a -> b -> c ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list3.Head, str_list3.Tail) // x - c
    fmt.Println()
    ...
    fmt.Printf("int_list1: %v\n", int_list1)    // [ 5 -> 4 -> 3 -> 2 -> 1 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list1.Head, int_list1.Tail)
    fmt.Printf("int_list2: %v\n", int_list2)    // [ 9 -> 8 -> 7 -> 6 -> 5 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list2.Head, int_list2.Tail)
    fmt.Printf("str_list2: %v\n", str_list2)    // [ d -> c -> b -> a ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list2.Head, str_list2.Tail)
    fmt.Printf("str_list3: %v\n", str_list3)    // [ a -> b -> c ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list3.Head, str_list3.Tail)
    fmt.Println()
    ...
    fmt.Println("Example golist Last, Length, Max, Min, Member, Nth, Prefix, Suffix and Search")
    ...
    int_list1.Reverse()
    fmt.Printf("int_list1: %v\n", int_list1)                            // [ 5 -> 4 -> 3 -> 2 -> 1 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list1.Head, int_list1.Tail) // 5 - 1
    fmt.Printf("str_list2: %v\n", str_list2)                            // [ d -> c -> b -> a ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list2.Head, str_list2.Tail) // d - a
    fmt.Println()
    ...
    fmt.Printf("int_list1: %v\n", int_list1)                            // [ 2 -> 3 -> 4 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list1.Head, int_list1.Tail) // 2 - 4
    fmt.Printf("str_list2: %v\n", str_list2)                            // [ d -> e ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list2.Head, str_list2.Tail) // d - e
    fmt.Println()
    ...
    fmt.Printf("int_list1: %v\n", int_list1)                            // [ 3 -> 1 -> 2 ]
    fmt.Printf("Head: %v - Tail: %v\n", int_list1.Head, int_list1.Tail) // 3 - 2
    fmt.Printf("str_list3: %v\n", str_list3)                            // [ c -> a -> b ]
    fmt.Printf("Head: %v - Tail: %v\n", str_list3.Head, str_list3.Tail) // c - b
    fmt.Println()
}
